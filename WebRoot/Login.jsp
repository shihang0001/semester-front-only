	...
	<div id="bg1">
		<div id="bg2">
			<div id="header">
				...
				<div id="menu">
					<ul>
						...
						<li><a href="cart.html" class="color2">Cart</a></li>
			...
			<div id="page">
				<div class="post" style="margin-bottom: 30px;">
					<div class="entry">
                <h2><span class="color3"> please clicked <a href="Register.jsp" class="color1">Resign</a></h2>
     ...
     <h2 class="form-signin-heading">Please log in</h2>
        ...
        <label class="checkbox">
          <input type="checkbox" value="remember-me"> Remember me(Demo part)
        </label>
        <button class="btn btn-large btn-primary" type="submit">log -email</button>
      </form>
