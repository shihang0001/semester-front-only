			...
			<div id="page">
				<div class="post" style="margin-bottom: 30px;">
					<div class="entry">
                          ...
                          <h2><span class="color3"> sorry,error!</span></h2>
                            <h2><span class="color3"> 404 not found</span></h2>
                <h2><span class="color2"> if you want to try again log in <a href="Login.jsp" class="color1">here!</a>to go back</span></h2>
                <h2><span class="color1"> if you want to register <a href="Login.jsp" class="color1">here!</a>to go back</span></h2>
                <h2><span class="color2"> if you want to add into cart <a href="Login.jsp" class="color1">here!</a>to go back</span></h2>
                <h2><span class="color3"> want to home ? <a href="inex.jsp" class="color1">here!</a>to go back</span></h2>
					</div>
