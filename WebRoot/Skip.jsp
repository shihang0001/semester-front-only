...
<h1>
    ...
    welcome <a href="index.jsp" class="color2">  <%= username %> !</a>
</h1>
<h1>    This is my JSP page. <br>
    Goods has been added to shopping cart!<br/>
    <a href="ProductList.jsp" class="color2">Buy more.</a><br/>
    <a href="ShoppingCart.jsp" class="color1">Pay now.</a> 
    </br></h1>	
